import { A as AstroError, w as MissingSharp } from './server_BFqXFhtk.mjs';
import { b as baseService, p as parseQuality } from './node_RUq1ohcf.mjs';
...
async function loadSharp() {
  let sharpImport;
  try {
    sharpImport = (await import('./index_DHlotNrI.mjs').then(n => n.i)).default;
  } catch {
